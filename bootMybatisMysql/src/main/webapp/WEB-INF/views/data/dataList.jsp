...
<div class="container">
	...
	<div id="listView">
		<ul>
			...
			<li>${vo.hit}</li>
			<li>
				<a href="/upload/${vo.filename1}" title="${vo.filename1}" download><img src="/img/disc.png" height="27" alt="${vo.no}"/></a>
				<c:if test="${vo.filename2!=null && vo.filename2!=''}">
					<a href="/upload/${vo.filename2}" title="${vo.filename2}" download><img src="/img/disc.png" height="27" alt="${vo.no}"/></a>
				</c:if>
			</li>
			<li>${vo.writedate}</li>
			</c:forEach>
