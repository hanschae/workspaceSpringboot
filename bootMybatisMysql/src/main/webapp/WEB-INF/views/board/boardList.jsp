...
<style>
	...
	#board li{
		float:left; line-height:40px; boarder-bottom:1px solid #ddd; width:10%;
	}
...
<div class="container">
	...
	<div>
		${pVO.totalPage} / ${pVO.nowPage}, 총 레코드 수 : ${pVO.totalRecord} 
	</div>
	<div>
	...
	<form method="post" action="/board/multiDel" id="listFrm">
		<ul id="board">
			...
			<c:forEach var="vo" items="${list }">
				...
				<li>${vo.no }-${vo.subject.length()}</li>
				
				<li>
					<div
						<c:if test = "${vo.subject.length() >= 40}">
							style='width:90%'
						</c:if>
					>
