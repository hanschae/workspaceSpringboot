...
public class Clova08_voice_controller {
	...
	public void voiceOk(@RequestParam("text") String text, HttpServletResponse res) {
		//////////////////////////
		String clientId = "n87mqnbukf";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "fRbidtJku3OTnmjviC8dxiM5QR7mxd1k6BrHBLpb";//애플리케이션 클라이언트 시크릿값";
        try {
            ...
            // post request
            String postParams = "speaker=nkyunglee&volume=0&speed=0&pitch=0&format=mp3&text=" + text;
