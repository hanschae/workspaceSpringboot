...
public class Clova09_chatbot_controller {
	String apiURL = "https://arb0m28b2r.apigw.ntruss.com/custom/v1/7763/eb8eff2b63540213b543caf86cd0ad7d5297a5d6555767b58557a7ca223a1ae6";
	String secretKey = "akhUbm55RmJQRnFOV1VDdElwcGRxQmtTSUlGTVF3Q1U=";
	...
	public static String makeSignature(String message, String secretKey) {
        ...
        try {
            ...
            encodeBase64String = Base64.encodeToString(rawHmac, Base64.NO_WRAP); // base64는 android
	...
	public static String getReqMessage(String voiceMessage) {
        ...
        try {
            ...
            // obj.put("userId", "0e5d37ed295347389b4607bde5b8fcc0");
