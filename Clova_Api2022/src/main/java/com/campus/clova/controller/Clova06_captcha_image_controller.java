...
public class Clova06_captcha_image_controller {
	String clientId="v9zf0t8onb"; // 애플리케이션 클라이언트 아이디값";
	String clientSecret="cqDqxSovbfyoy7oUMlbj6SrrJYjwcvnfXfCziJw5"; // 애플리케이션 클라이언트 시크릿값";
